                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('products.update', $product) }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea id="description" class="form-control @error('description') is-invalid @enderror"
                                          name="description" rows="4" placeholder="Describe your product...">{{ old('description', $product->description) }}</textarea>
                        ...
                        @if($product->hasImages())
                            <div class="row mb-3">
                                <label class="col-md-4 col-form-label text-md-end">{{ __('Current Images') }}</label>
                                <div class="col-md-6">
                                    <div class="current-images-display">
                                        <div class="row g-2">
                                            @if($product->image)
                                                <div class="col-auto">
                                                    <div class="position-relative">
                                                        <img src="{{ $product->image_url }}" alt="Primary Image"
                                            ...
                                            @if($product->images && is_array($product->images))
                                                @foreach($product->images as $image)
                                                    <div class="col-auto">
                                                        <img src="{{ asset('storage/products/' . $image) }}" alt="Additional Image"
                                                             class="img-thumbnail" style="width: 100px; height: 100px; object-fit: cover;">
                                                    </div>
                                                @endforeach
                                            @endif
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <small class="form-text text-muted">
                                    <i class="bi bi-info-circle me-1"></i>
                                    Leave empty to keep current images. You can select multiple images. Max 5 images, 2MB each.
                                </small>
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <a href="{{ route('products.show', $product) }}" class="btn btn-secondary ms-2">
